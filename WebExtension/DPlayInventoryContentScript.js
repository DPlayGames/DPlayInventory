(() => {
	...
	on('login', (params, callback) => {
		...
		// 로그인 창을 엽니다.
		window.open(chrome.runtime.getURL('login-popup.html'), 'extension_popup', 'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=300,height=300');
	});
